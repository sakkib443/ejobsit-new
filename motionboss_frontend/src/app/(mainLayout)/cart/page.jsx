    ...
    if (items.length === 0) {
        return (
            <div className="min-h-[70vh] flex flex-col items-center justify-center bg-gray-50 px-4">
                ...
                <Link
                    href="/software"
                    className="px-10 py-4 bg-[#41bfb8] text-white rounded-2xl font-bold shadow-xl shadow-[#41bfb8]/30 hover:scale-105 transition-all active:scale-95"
                >
                    Start Shopping
                </Link>
            </div>
        ...
        <div className="min-h-screen bg-gray-50 py-12 lg:py-20">
            <div className="container mx-auto px-4 lg:px-16">
                ...
                <div className="flex items-center gap-4 mb-10">
                    <Link href="/" className="p-3 bg-white rounded-xl shadow-sm text-gray-400 hover:text-[#41bfb8] transition-all">
                        <LuArrowLeft size={20} />
                    </Link>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
                    ...
                    <div className="lg:col-span-8 space-y-4">
                        {items.map((item) => (
                            <div key={item.id} className="bg-white p-4 lg:p-6 rounded-[2rem] border border-gray-100 shadow-sm flex flex-col sm:flex-row items-center gap-6 group hover:shadow-xl hover:border-[#41bfb8]/20 transition-all">
                                <div className="w-full sm:w-32 aspect-square rounded-2xl overflow-hidden bg-gray-100 shrink-0">
                                    <img src={item.image} alt={item.title} className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500" />
                                </div>
                                <div className="flex-1 space-y-2 text-center sm:text-left">
                                    <div className="flex flex-wrap justify-center sm:justify-start gap-2 mb-1">
                                        <span className="px-2 py-0.5 bg-gray-100 text-[10px] font-black uppercase text-gray-500 rounded">
                                            {item.type}
                                        </span>
                                    </div>
                                    ...
                                    <p className="text-sm text-gray-400 font-medium">MotionBoss verified digital asset</p>
                                </div>
                    ...
                    <div className="lg:col-span-4 lg:sticky lg:top-28">
                        <div className="bg-white p-8 rounded-[2.5rem] border border-gray-100 shadow-xl space-y-8">
                            ...
                            <Link
                                href="/checkout"
                                className="w-full flex items-center justify-center gap-3 py-5 bg-[#41bfb8] hover:bg-[#38a89d] text-white rounded-2xl font-bold text-xl shadow-xl shadow-[#41bfb8]/30 transition-all active:scale-95 group"
                            >
                                Checkout Now
