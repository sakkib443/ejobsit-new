...
export default function MentorProfilePage() {
    ...
    const inputClass = `w-full px-4 py-3.5 rounded-2xl border-2 outline-none transition-all text-sm font-medium ${isDark
        ? 'bg-slate-800/50 border-slate-700/50 text-white focus:border-amber-500 focus:bg-slate-800'
        : 'bg-white border-slate-200 text-slate-800 focus:border-amber-500 focus:shadow-lg focus:shadow-amber-500/10'
    ...
    return (
        <div className="min-h-screen">
            ...
            <div className="relative overflow-hidden">
                {/* Background Gradient - Orange/Amber for Mentor */}
                    ...
                    <div className="max-w-6xl mx-auto">
                        <div className="flex flex-col md:flex-row items-center gap-8">
                            ...
                            <div className="relative group">
                                <div className="absolute inset-0 bg-gradient-to-br from-white to-amber-200 rounded-3xl blur-xl opacity-50 group-hover:opacity-75 transition-opacity" />
                                ...
                                <button
                                    ...
                                    className="absolute -bottom-2 -right-2 w-12 h-12 rounded-2xl bg-white text-amber-600 flex items-center justify-center shadow-xl hover:scale-110 transition-transform border-4 border-amber-600"
                                >
                                    <FiCamera size={20} />
                                </button>
                                {/* Mentor Badge */}
                                <div className="absolute -top-3 -right-3 px-3 py-1.5 bg-gradient-to-r from-amber-500 to-orange-500 text-white text-[10px] font-black uppercase tracking-wider rounded-lg shadow-lg border-2 border-white">
                                    Mentor
                                </div>
                            </div>
            ...
            <div className="max-w-6xl mx-auto px-6 -mt-8">
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                    {[
                        { icon: FiBook, label: 'Courses Created', value: '0', color: 'from-amber-500 to-orange-500' },
                        { icon: FiLayers, label: 'Total Modules', value: '0', color: 'from-blue-500 to-indigo-500' },
                        { icon: FiPlay, label: 'Total Lessons', value: '0', color: 'from-rose-500 to-pink-500' },
                        { icon: FiUsers, label: 'Students', value: '0', color: 'from-emerald-500 to-teal-500' },
                    ].map((stat, idx) => (
                        ...
                        <div className={`flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 p-6 border-b ${isDark ? 'border-slate-700/50' : 'border-slate-100'}`}>
                            ...
                            {!isEditing ? (
                                <button
                                    ...
                                    className="flex items-center gap-2 px-5 py-2.5 bg-gradient-to-r from-amber-500 to-orange-500 hover:from-amber-600 hover:to-orange-600 text-white rounded-xl font-semibold text-sm transition-all shadow-lg shadow-amber-500/25"
                                >
                                    <FiEdit3 size={16} />
                                    Edit Profile
                                </button>
                                ...
                                <div className="flex gap-2">
                                    ...
                                    <button
                                        onClick={handleSave}
                                        disabled={loading}
                                        className="flex items-center gap-2 px-5 py-2.5 bg-gradient-to-r from-amber-500 to-orange-500 text-white rounded-xl font-semibold text-sm transition-all shadow-lg shadow-amber-500/25 disabled:opacity-50"
                                    >
                                        <FiSave size={16} />
                            ...
                            <div className="grid md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    ...
                                    <div className="relative">
                                        ...
                                        />
                                        <span className="absolute right-3 top-1/2 -translate-y-1/2 px-2 py-1 bg-amber-100 text-amber-600 text-[10px] font-bold rounded-md uppercase">
                                            Mentor
                                        </span>
                                    </div>
                                </div>
