...
import {
  ...
  FiTarget, FiList, FiAward, FiTag, FiSearch, FiLayout, FiClock
} from 'react-icons/fi';
        ...
        <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4 mb-8">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-slate-500 text-sm mt-1">Publish a professional course to the marketplace</p>
            </div>
          </div>
          <button
          ...
          >
            {loading ? <><FiPlus className="animate-spin" /> Publishing...</> : <><FiSave /> Publish Course</>}
          </button>
        </div>
